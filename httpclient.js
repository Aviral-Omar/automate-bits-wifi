...
//date +%s%N | cut -b1-13
// 'mode=191&username=F20190411&password=B3PS043904%23&a=1673289294437&producttype=0';
...
function openRegisterWindow(d) {
	...
	var b =
		...
		',scrollbars=no';
	var c =
		typeof window.opener != 'undefined' && navigator.userAgent.indexOf('MSIE') != -1
...
function renderLoginBox() {
	...
	var c = createElement('div', { id: 'credentials', style: 'margin:15px;' }, [
		createElement('input', { id: 'username', placeholder: usernameCaption, type: 'text' }),
		createElement('input', { id: 'password', placeholder: passwordCaption, type: 'password' }),
		createElement('input', {
			id: 'loginbtn',
			type: 'button',
